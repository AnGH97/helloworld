...
/**
 * Category2_has_product 관리 기능과 관련된 MyBatis Mapper를 간접적으로 호출하기 위한 기능 명세.
 * 하나의 처리를 위해서 두 개 이상의 기능을 연동할 필요가 있을 경우,
 * 이 인터페이스의 구현체(Impl)을 통해서 처리한다.
 */
public interface Category2_has_productService {

    /**
     * Category2_has_product 정보를 새로 저장하고 저장된 정보를 조회하여 리턴한다.
    ...
    /**
     * Category2_has_product 정보를 수정하고, 수정된 정보를 조회하여 리턴한다.
    ...
    /**
     * Category2_has_product 정보를 삭제한다.
     * 삭제 후 Category2_has_product 테이블에서 영향을 받은 행 수가 없거나,
     * SQL에 에러가 있는 경우는 예외를 발생시켜서
     * 이 메서드를 호출하는 위치에서 try~catch 구문을 강제적으로
     * 사용하도록 throws를 명시한다.
     * 
     * @param params - 삭제될 Category2_has_product의 정보를 담고 있는 Beans
     * @return - Void
    ...
    /**
     * Category2_has_product 하나의 정보를 조회하여 리턴한다.
     * 
     ...
     * @throws Exception            - SQL처리에 실패한 경우
     */
    public Category2_has_productModel selectItem(Category2_has_productModel input) throws NullPointerException, Exception;

    /**
     * Category2_has_product 목록을 조회하여 리턴한다.
     * 
     ...
     * @throws Exception            - SQL처리에 실패한 경우
     */
    public List<Category2_has_productModel> selectList(Category2_has_productModel input) throws NullPointerException, Exception;
