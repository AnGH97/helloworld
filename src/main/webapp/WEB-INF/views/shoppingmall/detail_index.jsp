...
<body>
    ...
    <div class="container">
        ...
        <!--메인 내용 영역-->
        <section class="main">
            <form class="product-choice" name="product-choice" id="product-choice">
                <div class="detail-top">
                    ...
                    <div class="detail-top-text">
                        ...
                        <div class="detail-top-text-second">
                            ...
                            <div class="detail-top-text-second-num2">   
                                ...
                                <div class="detail-top-text-second-right">
                                    <a class="right-first" href="#">펼쳐보기<i class="fa fa-angle-down" aria-hidden="true"></i>
                                        <ul class="membership">
                                            <li>멤버쉽 할인가</li>
                        ...
                        <div class="detail-top-text-fourth">
                            <div class="shopping-cart"><a href="#"><p>장바구니</p></a></div>
            ...
            <div class="detail-top-with-items">
                <div class="detail-top-with-items-first">
                    <a href="#"><img src="${contextPath}/assets/img/andar-deatil-top-img1.jpg"/>
                ...
                <div class="detail-top-with-items-second">
                    <a href="#"><img src="${contextPath}/assets/img/andar-deatil-top-img2.jpg"/>
                        <div class="detail-top-with-items-text">
                            <span class="detail-top-with-items-name"><p>[1+1] 에어쿨링 지니 시그니처 레깅스</p></span>
                            <span class="detail-top-with-items-price"><p class="sale">50%</p> <p class="s-price">49,000원</p> <p class="r-price">98,000원</p></span>
                        </div>
                ...
                <div class="detail-top-with-items-third">
                    <a href="#"><img src="${contextPath}/assets/img/andar-deatil-top-img3.jpg"/>
                        <div class="detail-top-with-items-text">
                            <span class="detail-top-with-items-name"><p>[1+1] 에어쿨링 지니 시그니처 레깅스</p></span>
                            <span class="detail-top-with-items-price"><p class="sale">50%</p> <p class="s-price">49,000원</p> <p class="r-price">98,000원</p></span>
                        </div>
                ...
                <div class="detail-top-with-items-fourth">
                    <a href="#"><img src="${contextPath}/assets/img/andar-deatil-top-img4.jpg"/>
                        <div class="detail-top-with-items-text">
                            <span class="detail-top-with-items-name"><p>[1+1] 에어쿨링 지니 시그니처 레깅스</p></span>
                            <span class="detail-top-with-items-price"><p class="sale">50%</p> <p class="s-price">49,000원</p> <p class="r-price">98,000원</p></span>
                        </div>
            ...
            <div class="detail-middle">
                <div class="detail-middle-menu">
                    <ul>
                        <li class="detail-middle-menu1"><a href="#">상세정보</a></li>
                        <li class="detail-middle-menu2"><a href="#">리뷰 3,620</a></li>
                        <li class="detail-middle-menu3"><a href="#">사이즈정보</a></li>
                        <li class="detail-middle-menu4"><a href="#">구매안내</a></li>
                    </ul>
                </div>
                <div class="detail-middle-review">
            ...
            <div class="detail-bottom">
                ...
                <span class="size-recomend"><p>사이즈추천</p></span>
                <div class="size-info">
