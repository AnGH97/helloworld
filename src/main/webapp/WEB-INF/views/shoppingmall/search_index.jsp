...
<head>
    ...
    <!--index stype-->
    <link rel="stylesheet" href="${contextPath}/assets/css/search_index.css" />
        ...
        <section class="main">
            <div class="search-answer">
                ...
                <div class="search-answer-menu">
                    <form class="search-answer-form" name="search-answer-form" id="search-answer-form">
            ...
            <div class="main-category-img">
                <div class="sort-list">
                    <span>442개의 상품</span>
                    <ul>
                        <li class="first-sort-list"><a href="#">상품정렬</a></li>
                        <li><a href="#">낮은가격</a></li>
                        <li><a href="#">높은가격</a></li>
                    </ul>
                </div>
